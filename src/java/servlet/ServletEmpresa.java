           ...
           // String autonomo = new String();
            ...
            switch (opcao) {
                case "cadastrar":
                    ...
                    //aluno.setAtividadeProf(empresa.getAtividade());
                ...
                case "alterar_2_passo":
                    //Setando dados do Empresa
                     List<Empresa> empresas = daoFactory.getEmpresaDao().perquisarPorAluno(Integer.parseInt(request.getParameter("aluno_id")));
                     if(empresas.size() > 0){
