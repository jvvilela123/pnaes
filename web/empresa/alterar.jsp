                                        ...
                                        <div class="card-content collpase show">
                                            <div class="card-body">
                                                ...
                                                <%                
                                                    ...
                                                    Empresa empresa = daoFactory.getEmpresaDao().pesquisarPorId(id);
                                                %>
                                                <form class="form form-horizontal striped-rows form-bordered" method="POST"
                                                    action="../ServletEmpresa?opcao=alterar&id=<%=id%>">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="responsavel" value="<%=empresa.getResponsavel()%>"
                                                                    id="responsavel" class="form-control" placeholder="Nome do responsavel">
                                                            </div>
                                                        </div>
