                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title" id="striped-row-layout-icons">Marcar Horário para a Entrevista</h4>
                                            ...
                                            <div class="card-content collpase show">
                                                <div class="card-body">
                                                    <div class="card-text">
                                                        Incritos com Documentos Analisados do Edital <%=edital.getNumeroEAno()%>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <form class="form form-horizontal form-bordered" method="POST" action="horario.jsp?pb=<%=request.getParameter("pBolsa")!=null?request.getParameter("pBolsa"):' '%>&pc=<%=request.getParameter("pCat")!=null?request.getParameter("pCat"):' '%>">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <a href="/pnaes/entrevista/horario.jsp"> <button type="button" value="Limpar" class="btn btn-danger">
                                                        ...
                                                        <form method="POST" action="../ServletEntrevista?opcao=cadastrarTudo&pb=<%=request.getParameter("pBolsa")!=null?request.getParameter("pBolsa"):' '%>&pc=<%=request.getParameter("pCat")!=null?request.getParameter("pCat"):' '%>" class="form-horizontal">
                                                            ...
                                                            <tr>
                                                                    <th>Data</th>
                                                                    <th><input class="form-control" name="dataEntrevista" type="date" value="<%=request.getParameter("data")!=null?request.getParameter("data"):""%>" required=""></th>
                                                                    <th>Local</th>
                                                                    <th><input class="form-control" name="local" type="text" value="<%=request.getParameter("local")!=null?request.getParameter("local"):""%>" required=""></th>
                                                                </tr></table>
